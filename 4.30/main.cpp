...
int main()
{
    ...
    double radius =0; // first integer to calculate (initialized to 0)
    double diameter =0; // diameter of radius multiply by the 3.14159
    double perimeter =0;//perimeter of radius multiply by the 2*3.141590
    double area =0; //area of radius multiply by the radius*3.14159
